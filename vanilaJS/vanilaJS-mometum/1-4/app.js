...
//submit 했을 때 새로고침 하는 것이 기본 동작. 브라우저 동작. 새로고침하면서 form의 내용을 submit 하는 것임 그것을 막아야함
//==== e.preventDefault(); 브라우저의 기본 동작을 막아줍니다.
...
function handleLinkClick(event){
    ...
    console.dir(event);
    // 엣지 : PointerEvent 
    // 크롬 : MouseEvent // 그러나 PinterEvent가 더 많나봄.
    alert("click!"); // alert은 모든 동작을 막아버리는 속성이 있음. 그래서 임제 아무도 안써..
}
