...
// form에 maclength 등을 활용하면 됨. type, required 등등
...
function onLoginSubmit(e){
    ...
    localStorage.setItem(USERNAME_KEY, username); //local storage는 우리가 브라우저 사용하며 저장된 것.
    ////////////////setItem은 local storage에 저장할 수 있게 해줌
