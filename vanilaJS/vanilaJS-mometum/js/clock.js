...
today1.getDate(); // 현재 날짜
today1.getDay(); // 오늘 요일 sunday 0
today1.getFullYear(); 
today1.getSeconds(); // 현재 초

new Date().getHours();// 현재 시
...
// 1.padStart(2,"0"); string 갯수가 2개가 아니라면 앞에 0을 붙여서 01로 표시함. = 01
// 1.padEnd(2,"0"); string 갯수가 2개가 아니라면 뒤에 0을 붙여서 10로 표시함. = 10
